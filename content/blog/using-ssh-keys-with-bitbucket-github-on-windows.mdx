...
**Sources:** [makandracards.com](https://makandracards.com/makandra/1303-how-to-use-git-on-windows-with-putty), [vladmihalcea.com](https://vladmihalcea.com/tutorials/git/windows-git-ssh-authentication-to-github/)
