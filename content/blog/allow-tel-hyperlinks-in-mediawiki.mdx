...
In MediaWiki you can already make email hyperlinks (`[mailto:someone@example.com Mail someone]`), but telephone number hyperlinks aren't allowed for some reason by default (`[tel:0123456789 Call someone]`). Turns out to be an [easy fix](http://www.mediawiki.org/wiki/Help_talk:Links#Adding_tel:_link) though.
