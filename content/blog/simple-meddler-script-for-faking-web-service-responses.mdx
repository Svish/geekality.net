...
I recently discovered [Meddler](http://webdbg.com/Meddler/) which is an HTTP generator based on JScript. Since there were not many samples to find and Google wasn't really of much help here, I figured I could share the scripts I write here. Maybe it helps someone out, and even more likely, I will probably have to look back at this at some time since I will forget 😛
