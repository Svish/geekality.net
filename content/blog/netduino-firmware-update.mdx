...
1. Download and install the latest <a href="http://netmf.codeplex.com/">_.NET Micro Framework SDK 4.3_</a>.<br/>(the 4.2 available from Netduino doesn't support VS 2012)
1. Download and install the <a href="http://netduino.com/downloads/">_Netduino SDK v4.2.1.0_</a>.<br/>(32-bit or 64-bit depending on your Windows version)
1. Download and install <a href="http://www.atmel.com/tools/ATMELSAM-BAIN-SYSTEMPROGRAMMER.aspx">_SAM-BA 2.13 for Windows_</a>.<br/>(you'll have to register and log in, but it's free)
1. Download and unzip the new <a href="http://wiki.netduino.com/Firmware.ashx">_Netduino firmware_</a>.
