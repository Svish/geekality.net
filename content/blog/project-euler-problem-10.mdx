...
Using our <a href="/?p=176">previously made</a> Eratosthenes class for generating primes, this problem can be solved in a very easy way.
...
Managed to finally implement another algorithm called the <a href="http://en.wikipedia.org/wiki/Sieve_of_Atkin">Sieve of Atkin</a>. I have written about it in <a href="/?p=674">a different post</a>.
