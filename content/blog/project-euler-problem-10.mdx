...
Using our [previously made](/?p=176) [`Eratosthenes` class](/?p=626) for generating primes, this problem can be solved in a very easy way.
...
Managed to finally implement another algorithm called the [Sieve of Atkin](https://en.wikipedia.org/wiki/Sieve_of_Atkin). I have written about it in [a different post](/?p=674).
