...
Turns out there is a handy package manager called [OpenCSW](http://www.opencsw.org) which luckily isn't too difficult to install. So from a mess to a mess with curl installed, here's what I did.
