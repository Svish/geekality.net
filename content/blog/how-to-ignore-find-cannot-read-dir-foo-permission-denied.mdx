...
<div className="note">
  ⚠ Remember that when you do this <em>all</em> errors will be sent to nowhere.
  So if there was any other errors, they would also be gone. In this case I
  don't care, but in other instances you might want to do something else. For
  example direct it to a log file rather than to oblivion.
</div>
