...
Last night I played around with <a href="http://www.technicpack.net/tekkit/">Tekkit</a> and the <a href="http://tekkitclassic.wikia.com/wiki/Mining_Turtle">Mining Turtle</a> which comes with it. The Turtle is part of the <a href="http://www.computercraft.info/">ComputerCraft</a> mod and can be programmed using <a href="http://en.wikipedia.org/wiki/Lua_(programming_language)">Lua</a> and the <a href="http://computercraft.info/wiki/index.php?title=Turtle_(API)">Turtle API</a>.
