...
How to enable <a href="http://php.net/manual/en/book.phar.php">Phar</a> and install <a href="https://getcomposer.org/">Composer</a> on <a href="https://www.dreamhost.com/">Dreamhost</a>.
...
Last step should output "Phar", if it all worked. If not, try the php.ini-way instead in <a href="http://blog.tretyakov.im/post/36063947129/add-phar-to-dreamhost">this guide</a> (which is where I found how to do this in the first place, but found it a bit unclear. Especially the last suhosin stuff).
