...
WinMerge supports that, and <em>can</em> be integrated with TortoiseSVN very easily right through its installer. But I prefer the diff viewer that comes with TortoiseSVN and the archive diff isn't recursive by default, so I decided to set it up manually.

1. Install <a href="http://winmerge.org/">WinMerge</a>
   - Deselect <i>Automagic TortoiseSVN integration</i>
2. Install the <a href="http://winmerge.org/downloads/plugins.php">WinMerge 7-zip plugin</a>
...
**Note:** When you're diffing archives in WinMerge, deselecting _Show Identical Items_ under _View_ makes actual differences much easier to see.
