...
So what do we do? We use a <a href="http://msdn.microsoft.com/en-us/library/system.threading.manualresetevent.aspx">ManualResetEvent</a> instead of the boolean flag:
...
I am still a total testing newbie at the moment and didn't have a clue what to do, so after some failing google-fu I asked <a href="https://stackoverflow.com/q/1770830/39321">a question</a> about it at <a href="http://stackoverflow.com">StackOverflow</a>. My solution is based on <a href="https://stackoverflow.com/a/1770862/39321">one of the answers</a> I got there 🙂
