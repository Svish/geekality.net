...
The first tool I use is <a href="http://www.dvdshrink.org/what_en.php">DVD Shrink</a> which I use to DVDs to my hard drive as iso image files. The tool I use for encoding _can_ read directly from the DVD, but this way I can copy a bunch of DVDs and then create encoding jobs for each of them in a queue and not having to swap DVDs between each job.
