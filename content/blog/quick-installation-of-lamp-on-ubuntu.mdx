...
Needed to get a <a href="http://en.wikipedia.org/wiki/LAMP_%28software_bundle%29">LAMP</a> environment up and running for some <a href="http://kohanaframework.org/">Kohana</a> development. Starting with a more or less fresh install of Ubuntu, here's what I did.
