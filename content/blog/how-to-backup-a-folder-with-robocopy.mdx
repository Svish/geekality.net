...
[Robocopy](http://en.wikipedia.org/wiki/Robocopy) is of course the command
...
You can either run this yourself in a Command Prompt or schedule it using the [Task Scheduler](http://windows.microsoft.com/en-us/windows/schedule-task). What is important to remember is that you should run this using Administrator rights.
