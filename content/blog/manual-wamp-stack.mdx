...
1. Download an <b>x64 Thread Safe zip</b> from <a href="http://windows.php.net/download/">php.net</a>.
...
1. Download the <b>Windows Installer</b> from <a href="https://getcomposer.org/download/">getcomposer.org</a>.
2. Run the installer..
...
1. Download the <b>Apache Win64 zip</b> from <a href="https://www.apachelounge.com/download/">apachelounge.com</a>.
...
1. Download a <b>Windows x86_64 MSI Package</b> via <a href="https://downloads.mariadb.org/">mariadb.org</a>.
2. Run the installer.
...
5. Check that it works by connecting with <a href="https://www.heidisql.com/">HeidiSQL</a> or any other SQL client.
