...
The [XslCompiledTransform](http://msdn.microsoft.com/en-us/library/system.xml.xsl.xslcompiledtransform.aspx) class of .NET only supports XSLT 1.0 for some annoying reason. I needed support for version 2.0 and for that I found the free [Saxon-HE](http://www.saxonica.com) library through [NuGet](http://www.nuget.org/packages/Saxon-HE).
