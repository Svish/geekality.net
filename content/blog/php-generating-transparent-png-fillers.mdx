...
If you want to check out a working demo version of this, you can try a little tool I created while having fun with this at [samples.geekality.net/filling-factory](http://samples.geekality.net/filling-factory/).
