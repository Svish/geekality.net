...
You can find the [`Triple`](http://abdullin.com/journal/2008/9/30/using-tuples-in-c-functions-and-dictionaries.html) class in a library called the [Lokad Shared Libraries](http://abdullin.com/shared-libraries/).
