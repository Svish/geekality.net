...
You can find the <a href="http://abdullin.com/journal/2008/9/30/using-tuples-in-c-functions-and-dictionaries.html">Triple</a> class in a library called the <a href="http://abdullin.com/shared-libraries/">Lokad Shared Libraries</a>.
