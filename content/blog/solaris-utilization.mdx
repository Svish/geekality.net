...
Commands for checking various utilization on Solaris. Notes to self, based on <a href="http://dennis_caparas.tripod.com/Configuring_sar_for_your_system.html">this</a>, <a href="http://www.ibm.com/developerworks/aix/library/au-unix-perfmonsar.html">this</a>, <a href="http://docs.oracle.com/cd/E23824_01/html/821-1451/spmonitor-8.html">this</a>, and <a href="http://www.cyberciti.biz/faq/unix-command-to-find-cpu-utilization/">this</a>. The sar command depends on regular collection of data by sa1 and sa2 commands. See bottom of post for how to set that up.
...
For what output means, see <a href="http://docs.oracle.com/cd/E23824_01/html/821-1451/spmonitor-8.html">this page</a>.
