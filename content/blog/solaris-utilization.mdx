...
Commands for checking various utilization on Solaris. Notes to self, based on [this](http://dennis_caparas.tripod.com/Configuring_sar_for_your_system.html), [this](http://www.ibm.com/developerworks/aix/library/au-unix-perfmonsar.html), [this](http://docs.oracle.com/cd/E23824_01/html/821-1451/spmonitor-8.html), and [this](http://www.cyberciti.biz/faq/unix-command-to-find-cpu-utilization/). The sar command depends on regular collection of data by sa1 and sa2 commands. See bottom of post for how to set that up.
...
For what output means, see [this page](http://docs.oracle.com/cd/E23824_01/html/821-1451/spmonitor-8.html).
