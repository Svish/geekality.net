...
Found a nice way of doing that in the <a href="https://devcenter.heroku.com/articles/local-maven-dependencies">heroku devcenter</a> documentation, so noting it down here for future reference.
