...
Just a copy of a function I found in <a href="http://jayteknews.blogspot.no/2011/08/excel-user-defined-function-nslookup.html">a blog post</a> for doing nslookup calls in a worksheet, in case I need it again in the future. I've changed the return value for failing lookups to a blank string, "", rather than "NotFound", but otherwise it's unchanged.
...
**Source:** <a href="http://jayteknews.blogspot.no/2011/08/excel-user-defined-function-nslookup.html">jayteknews.blogspot.no</a>
