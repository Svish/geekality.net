...
For my small website <a href="https://github.com/Svish/myhymnal">myhymnal.net</a> I wanted a nice error handler that caught <em>all</em> errors and presented them as nice error pages. The problem is that you have at least three kinds of errors which you have to handle in PHP. Uncaught exceptions, regular errors and fatal errors. After some experimenting I think I've found a way to catch them all in a close to consistent matter so that they are easy to deal with.
