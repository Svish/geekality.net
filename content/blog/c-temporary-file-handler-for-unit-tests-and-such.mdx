...
For fun I also created a <a href="http://www.nuget.org/">Nuget</a> package for this, so that it's easy to add to projects when I need it. Works pretty perfectly, if I may say so myself 🙂 Feedback is welcome!

Source: <a href="https://github.com/Svish/geekality.io">github.com/Svish/geekality.io</a><br/>
Nuget: <a href="https://www.nuget.org/packages/Geekality.IO">nuget.org/packages/Geekality.IO</a>
