...
For fun I also created a [Nuget](http://www.nuget.org/) package for this, so that it's easy to add to projects when I need it. Works pretty perfectly, if I may say so myself. 🙂
