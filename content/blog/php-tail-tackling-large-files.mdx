...
You can try out a slightly modified version at <a href="http://samples.geekality.net/tail/">samples.geekality.net/tail</a>. Of course you won't be able to try it on your multi-gigabyte-sized log file, but at least you can see if it does what it should 🙂
