...
Just discovered how super simple it was to add some gz compression when for example <a href="/?p=1021" title="How to easily provide JSON and JSONP">providing JSON data</a> from PHP.

All you need is regular output buffering with the <a href="http://php.net/manual/en/function.ob-gzhandler.php">ob_gzhandler</a> as output callback.
