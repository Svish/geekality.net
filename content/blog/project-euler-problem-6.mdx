...
So, apparently <a href="http://blog.vi-kan.net/">my brother</a> has joined me on my <a href="https://projecteuler.net/">Project Euler</a> solving quest. You can see his Delphi solution <a href="http://blog.vi-kan.net/2009/project-euler-problem-6/">on his blog</a>. My C# solution, you can find below 🙂
...
However, my brother went further and found some pretty smart optimizations. Had to have a look at those of course and see if I could make sense of those too. It all boils down to <a href="http://www.math.com/tables/expansion/power.htm">expansion of power summations</a>.
