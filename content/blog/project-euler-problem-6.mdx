...
So, apparently [my brother](http://blog.vi-kan.net/) has joined me on my [Project Euler](https://projecteuler.net/) solving quest. You can see his Delphi solution [on his blog](http://blog.vi-kan.net/2009/project-euler-problem-6/). My C# solution, you can find below 🙂
...
However, my brother went further and found some pretty smart optimizations. Had to have a look at those of course and see if I could make sense of those too. It all boils down to [expansion of power summations](http://www.math.com/tables/expansion/power.htm).
