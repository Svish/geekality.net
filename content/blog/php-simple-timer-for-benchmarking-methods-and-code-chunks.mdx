...
I have published the code at <a href="https://github.com/Svish/TimerPHP">GitHub</a> so you can download and check out the source there. Since I've started to use <a href="https://getcomposer.org/">Composer</a> I also created a package for it and added it to <a href="https://packagist.org/packages/geekality/timer">Packagist</a>.
