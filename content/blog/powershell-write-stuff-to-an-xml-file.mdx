...
Needed to recursively list all the files of a certain type and save them as an XML file. Turns out this was <a href="https://www.rogerdelph.com/creating-xml-documents-from-powershell/">pretty easy</a> using PowerShell.
