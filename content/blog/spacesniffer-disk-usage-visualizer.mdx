...
Ever wondered what eats up your disk space? <a href="http://superuser.com/a/132932/62">Discovered</a> a nice simple tool which can answer that question. It's called <a href="http://www.uderzo.it/main_products/space_sniffer/">**SpaceSniffer**</a> and it scans your disk (or a just folder if you want) and then creates a clean map of what takes up space.
