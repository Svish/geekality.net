...
Could've maybe used <a href="http://php.net/manual/function.preg-replace-callback.php">`preg_replace_callback()`</a>, but felt wrong since I didn't actually want to do any _replacing_. I just needed my function to be called for each match.
