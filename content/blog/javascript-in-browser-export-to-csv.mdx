...
This function will turn an array of data into a CSV file and get the browser to "download" it. It <em>should</em> also be wrapping and escaping values properly <em>and</em>, because of the BOM, be read correctly when opened in e.g. Excel.
