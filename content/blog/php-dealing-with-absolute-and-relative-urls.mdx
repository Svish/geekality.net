...
Luckily, I found a function on [nashruddin.com](http://nashruddin.com/PHP_Script_for_Converting_Relative_to_Absolute_URL) which seem to handle them alright. After a bit of clean up and fixing an error, we have this function:
