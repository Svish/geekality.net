...
This will be a very quick one, thanks to <a href="/?p=626">the prime number generator</a> created earlier for <a href="http://www.geekality.net/?p=176">problem 3</a>. All we need is actually this one line of code:
