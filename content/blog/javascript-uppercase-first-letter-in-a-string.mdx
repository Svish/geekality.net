...
In PHP there is a very handy function called [`ucfirst`](http://php.net/ucfirst) which
...
Luckily, I quickly found [a function](http://stackoverflow.com/q/1026069/39321#1026087) over at StackOverflow that I adjusted slightly and added to the string class:
