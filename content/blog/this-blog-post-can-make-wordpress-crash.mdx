...
And sure enough, I had mentioned a PHP function called <a href="http://php.net/manual/en/function.curl-exec.php">`curl_exec`</a> in my blog post. Once I removed that word, the post could be previewed and saved just fine. Great stuff...
