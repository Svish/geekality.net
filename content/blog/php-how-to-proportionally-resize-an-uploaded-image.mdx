...
You can check out a working sample and complete source code at [samples.geekality.net/image-resize](http://samples.geekality.net/image-resize/). Don't abuse it 😉
