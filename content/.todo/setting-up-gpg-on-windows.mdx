...
What I did to get from zero to a good working (hopefully) secure GPG key set, usable for [signing](/?p=3086) and encrypting stuff on Windows...

<ol>
<li>Install [Gpg4win](https://www.gpg4win.org).
