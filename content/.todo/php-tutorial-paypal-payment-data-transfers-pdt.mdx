...
<del dateTime="2011-08-01T18:52:38+00:00">
  For this step I'll just quote their [PDT
  page](https://developer.paypal.com/webapps/developer/docs/classic/paypal-payments-standard/integration-guide/paymentdatatransfer/){' '}
...
<img
  src="http://www.geekality.net/wp-content/uploads/2010/10/Capture.jpg"
...
Sending the Transaction ID and our PDT Identity Token back to PayPal can be done in various ways from PHP. I used [cURL](http://php.net/manual/en/ref.curl.php) which I found to be pretty clean and easy to use.
