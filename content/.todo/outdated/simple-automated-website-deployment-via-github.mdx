...
You should now be able to visit <code inline="true">http://<your-website>/deploy.cgi</code> in your browser and see output like this:
...
Go to <code inline="true">https://github.com/<you>/<website>/settings/hooks</code>, click on WebHook URLs and enter the full URL to your script, <code inline="true">http://<your-website>/deploy.cgi</code>
