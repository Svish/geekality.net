...
What I did to get from <a href="/?p=3077">working GPG</a> to <a href="https://github.com/blog/2144-gpg-signature-verification">green and verified signatures</a> for Git commits and tags on GitHub.
...
<li>Copy it.
<li>Go to <a href="https://github.com/settings/keys">GPG keys</a> on GitHub.
<li>New GPG Key.
<li>Paste it.
<li>Add GPG Key.
<li>Pushed commits and tags should now look verified, as in this post: <a href="https://github.com/blog/2144-gpg-signature-verification">GPG signature verification</a>...
</ol>

<i>
  <b>Sources:</b>{' '}
  <a href="https://help.github.com/articles/telling-git-about-your-gpg-key/">
    help.github.com
  </a>
  , <a href="https://stackoverflow.com/a/42008822/39321">StackOverflow</a>, <a href="https://git-scm.com/book/es/v2/Git-Tools-Signing-Your-Work">git-scm.com</a>
</i>
