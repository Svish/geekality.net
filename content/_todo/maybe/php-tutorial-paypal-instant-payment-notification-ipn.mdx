...
page after doing the payment. That will <em>often</em> happen, but it's not guaranteed
to happen. If you for example want to mark an order in your system as paid or something
like that, you most likely want to use PayPal Instant Payment Notifications (IPN)
in addition to PDT.
