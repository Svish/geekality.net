...
Needed to get a [LAMP](https://en.wikipedia.org/wiki/LAMP_%28software_bundle%29) environment up and running for some [Kohana](https://kohanaframework.org/) development. Starting with a more or less fresh install of Ubuntu, here's what I did.
