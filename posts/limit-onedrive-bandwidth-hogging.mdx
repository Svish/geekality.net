...
Have a really horrible internet connection currently, and whenever Windows Update and OneDrive starts downloading stuff, I can basically not do anything else because they're hogging _all_ my bandwidth.
...
<Note>
  <dl>
    <dt>Source</dt>
    <dd>[SuperUser.com](https://superuser.com/q/1039229/62)</dd>
  </dl>
</Note>
