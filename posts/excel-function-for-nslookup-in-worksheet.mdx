---
title: 'Excel: Function for nslookup in worksheet'
published: '2016-03-07'
permalinks:
  - /2016/03/07/excel-function-for-nslookup-in-worksheet/
  - /?p=2915
categories:
...
Just a copy of a function I found in [a blog post](https://jayteknews.blogspot.no/2011/08/excel-user-defined-function-nslookup.html) for doing nslookup calls in a worksheet, in case I need it again in the future. I've changed the return value for failing lookups to a blank string, "", rather than "NotFound", but otherwise it's unchanged.
   ...
   If lookupVal <> "" Then
        ...
        ElseIf intFound > 0 Then
            ...
            If addressOpt = ADDRESS_LOOKUP Then
                ...
                nameStr = Trim(Mid(cmdStr, loc1 + 8, loc2 - loc1 - 😎)
            ElseIf addressOpt = NAME_LOOKUP Then
...
Usage, given an IP in cell `A1`, to get the hostname:
...
<Note>
  <dl>
    <dt>Source</dt>
    <dd>
      [jayteknews.blogspot.no](https://jayteknews.blogspot.no/2011/08/excel-user-defined-function-nslookup.html)
    </dd>
  </dl>
</Note>
